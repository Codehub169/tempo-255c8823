...
echo "
ud83d
de80 Starting Chat with PDF application setup..."
...
_internal```json_tool_code
print(default_api.FileGenerationList(items=[{'file_path': 'app.py', 'content': 'import streamlit as st
